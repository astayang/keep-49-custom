    ...
    Credentials({
      ...
      async authorize(credentials): Promise<User | null> {
        try {
          ...
          console.log("🔥 [DB Auth] getApiURL() returned:", apiUrl);
          console.log("🔥 [DB Auth] Full request URL:", `${apiUrl}/signin`);
          ...
          try {
            ...
            console.error("🔥 [DB Auth] FETCH FAILED:", fetchError);
            console.error("🔥 [DB Auth] Error type:", fetchError instanceof Error ? fetchError.constructor.name : typeof fetchError);
            console.error("🔥 [DB Auth] Error message:", fetchError instanceof Error ? fetchError.message : String(fetchError));
            throw fetchError;
          }

          console.log("🔥 [DB Auth] Response status:", response.status);
          console.log("🔥 [DB Auth] Response headers:", Object.fromEntries(response.headers));
          
          const responseText = await response.text();
          console.log("🔥 [DB Auth] Response body:", responseText);
